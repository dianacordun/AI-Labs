...
class Joc:
    ...
    def final(self):
        ...
        if (rez):
            pozitii_castigatoare = []
            if elem_identice(self.matr[0]):
                pozitii_castigatoare = [(0,0),(0,1),(0,2)]
            elif elem_identice(self.matr[1]):
                pozitii_castigatoare = [(1, 0), (1, 1), (1, 2)]
            elif elem_identice(self.matr[2]):
                pozitii_castigatoare = [(2, 0), (2, 1), (2, 2)]
            elif elem_identice([self.matr[0][0], self.matr[1][0], self.matr[2][0]]):
                pozitii_castigatoare = [(0, 0), (1, 0), (2, 0)]
            elif elem_identice([self.matr[0][1], self.matr[1][1], self.matr[2][1]]):
                pozitii_castigatoare = [(0, 1), (1, 1), (2, 1)]
            elif elem_identice([self.matr[0][2], self.matr[1][2], self.matr[2][2]]):
                pozitii_castigatoare = [(0, 2), (1, 2), (2, 2)]
            elif elem_identice([self.matr[0][0], self.matr[1][1], self.matr[2][2]]):
                pozitii_castigatoare = [(0, 0), (1, 1), (2, 2)]
            elif elem_identice([self.matr[0][2], self.matr[1][1], self.matr[2][0]]):
                pozitii_castigatoare = [(0, 2), (1, 1), (2, 0)]

            # colorez cu verde celulele de pe pozitiile castigatoare
            pygame.draw.rect(self.__class__.display, (0, 255, 0), self.__class__.celuleGrid[pozitii_castigatoare[0][0]][pozitii_castigatoare[0][1]])
            pygame.draw.rect(self.__class__.display, (0, 255, 0), self.__class__.celuleGrid[pozitii_castigatoare[1][0]][pozitii_castigatoare[1][1]])
            pygame.draw.rect(self.__class__.display, (0, 255, 0), self.__class__.celuleGrid[pozitii_castigatoare[2][0]][pozitii_castigatoare[2][1]])

            if self.matr[pozitii_castigatoare[0][0]][pozitii_castigatoare[0][1]] == 'x':
                self.__class__.display.blit(self.__class__.x_img, (pozitii_castigatoare[0][1] * (self.__class__.dim_celula + 1),
                                                                   pozitii_castigatoare[0][0] * (self.__class__.dim_celula + 1) + (
                                                                           self.__class__.dim_celula - self.__class__.x_img.get_height()) // 2))
                self.__class__.display.blit(self.__class__.x_img, (pozitii_castigatoare[1][1] * (self.__class__.dim_celula + 1),
                                                                   pozitii_castigatoare[1][0] * (self.__class__.dim_celula + 1) + (
                                                                           self.__class__.dim_celula - self.__class__.x_img.get_height()) // 2))
                self.__class__.display.blit(self.__class__.x_img, (pozitii_castigatoare[2][1] * (self.__class__.dim_celula + 1),
                                                                   pozitii_castigatoare[2][0] * (self.__class__.dim_celula + 1) + (
                                                                           self.__class__.dim_celula - self.__class__.x_img.get_height()) // 2))
            elif self.matr[pozitii_castigatoare[0][0]][pozitii_castigatoare[0][1]] == '0':
                self.__class__.display.blit(self.__class__.zero_img, (pozitii_castigatoare[0][1] * (self.__class__.dim_celula + 1),
                                                                      pozitii_castigatoare[0][0] * (self.__class__.dim_celula + 1) + (
                                                                              self.__class__.dim_celula - self.__class__.zero_img.get_height()) // 2))
                self.__class__.display.blit(self.__class__.zero_img, (pozitii_castigatoare[1][1] * (self.__class__.dim_celula + 1),
                                                                      pozitii_castigatoare[1][0] * (self.__class__.dim_celula + 1) + (
                                                                              self.__class__.dim_celula - self.__class__.x_img.get_height()) // 2))
                self.__class__.display.blit(self.__class__.zero_img, (pozitii_castigatoare[2][1] * (self.__class__.dim_celula + 1),
                                                                      pozitii_castigatoare[2][0] * (self.__class__.dim_celula + 1) + (
                                                                              self.__class__.dim_celula - self.__class__.x_img.get_height()) // 2))
