...
class Graph:  # graful problemei
    ...
    # euristica banala
    # costul minim daca nu e scop ! atentie, nu este mereu 1
    def calculeaza_h(self, infoNod, tip_euristica="euristica banala"):
        ...
        # Ex 22
            ...
            return 3 * math.ceil((infoNod[0] + infoNod[1]) / (self.M - 1)) + (1 - infoNod[2]) - 1
        else:
            ...
            # inmultit cu 2 pt ca trebuie sa se si intoarca barca
            # stanga-dreapta tot duc oameni
            ...
            # renunt la conditia cu canibali < misionari
        # o euristica admisibila suma oamenilor / M, dar am imbunatatit
        # dar barca trb sa vina macar cu un om
        # (1 - infoNod[2]) - 1  codificare if, verifica unde este barca, daca e deja la final nu se mai scade
...
4c 4m (b) ------------- 1c 1m  3locuri


Succesori pentru 3c 3m (b)...0c 0m  (3,3,1)
